...
-- INSERT INTO MediaItems (user_id, filename, filesize, media_type, title, description, serving, cook_time, ingredients, instruction) VALUES
...
-- DELETE FROM Likes WHERE media_id = 4;
-- DELETE FROM Comments WHERE media_id = 4;
-- DELETE FROM Ratings WHERE media_id = 4;
-- DELETE FROM MediaItemTags WHERE media_id = 4;
-- DELETE FROM MediaItems WHERE media_id = 4;
